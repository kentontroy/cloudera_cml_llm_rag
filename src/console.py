...
if __name__ == "__main__":
  ...
  parser.add_argument("-m", "--model", type=str, required=False, help="Specify either LLAMA2 or GPT4All as the model")
  ...
  if args.model:
    modelName = args.model.upper().strip()
    if modelName == "LLAMA2":
       model = MyModel(modelName=ModelName.LLAMA2, verbosity=args.verbose)
    else:
       print("Invalid model specified. Only supporting LLaMA2 at this time")
