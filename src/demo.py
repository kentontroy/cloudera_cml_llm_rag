...
from model import MyModel, ModelName
...
#########################################################################
load_dotenv()
MODEL = MyModel(modelName=ModelName.LLAMA2, verbosity=False)
...
MODELS = ["airoboros-l2-7b-2.1.Q4_K_M.gguf", "kimiko-v2-13b.Q4_K_M.gguf"]
...
def setModel(name) -> None:
  os.environ["LLAMA2_MODEL_FILE"] = name
    ...
    with gr.Column(scale=1, min_width=200):
      ...
      with gr.Row():
        modelDropdown = gr.Dropdown(
          MODELS,
          multiselect = False,  
          value = os.getenv("LLAMA2_MODEL_FILE"),
